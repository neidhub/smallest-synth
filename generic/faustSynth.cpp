  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; (i1 < count); i1 = (i1 + 1)) {
			iVec0[0] = 1;
			iRec0[0] = ((iVec0[1] + iRec0[1]) % 8192);
			table[i1] = std::sin((0.000766990415f * float(iRec0[0])));
			iVec0[1] = iVec0[0];
			iRec0[1] = iRec0[0];
		}
	}
...
static float ftbl0mydspSIG0[8192];
...
class mydsp : public dsp {
 ...
 public:
	...
	static void classInit(int sample_rate) {
		...
		sig0->fillmydspSIG0(8192, ftbl0mydspSIG0);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			output0[i0] = FAUSTFLOAT(ftbl0mydspSIG0[int((8192.0f * fRec1[0]))]);
			fRec1[1] = fRec1[0];
		}
	}
