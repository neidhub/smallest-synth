...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst6 = (1.0f / std::max<float>(1.0f, (0.400000006f * fConst0)));
	...
	virtual void instanceResetUserInterface() {
		fEntry0 = FAUSTFLOAT(400.0f);
		fEntry1 = FAUSTFLOAT(0.5f);
		fButton0 = FAUSTFLOAT(0.0f);
		fHslider0 = FAUSTFLOAT(127.0f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("cc1", &fHslider0, 127.0f, 0.0f, 127.0f, 1.0f);
		ui_interface->addNumEntry("freq", &fEntry0, 400.0f, 0.0f, 20000.0f, 0.100000001f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = std::max<float>(fSlow0, 23.4489498f);
		float fSlow3 = std::max<float>(20.0f, std::fabs(fSlow2));
		float fSlow4 = (fConst2 / fSlow3);
		float fSlow5 = (fConst3 * fSlow3);
		float fSlow6 = std::max<float>(0.0f, std::min<float>(2047.0f, (fConst4 / fSlow2)));
		float fSlow7 = std::floor(fSlow6);
		float fSlow8 = (fSlow7 + (1.0f - fSlow6));
		int iSlow9 = int(fSlow6);
		float fSlow10 = (fSlow6 - fSlow7);
		int iSlow11 = (iSlow9 + 1);
		float fSlow12 = float(fButton0);
		int iSlow13 = (fSlow12 == 0.0f);
		float fSlow14 = (fConst8 * ((0.169158012f * mydsp_faustpower2_f(float(fHslider0))) + 1.0f));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iVec0[0] = 1;
			fRec2[0] = (fSlow5 + (fRec2[1] - std::floor((fSlow5 + fRec2[1]))));
			float fTemp0 = mydsp_faustpower2_f(((2.0f * fRec2[0]) + -1.0f));
			fVec1[0] = fTemp0;
			float fTemp1 = (fSlow4 * (float(iVec0[1]) * (fTemp0 - fVec1[1])));
			fVec2[(IOTA & 4095)] = fTemp1;
			fRec1[0] = (((0.999000013f * fRec1[1]) + fTemp1) - ((fSlow8 * fVec2[((IOTA - iSlow9) & 4095)]) + (fSlow10 * fVec2[((IOTA - iSlow11) & 4095)])));
			fVec3[0] = fSlow12;
			fRec3[0] = (fSlow12 + (fRec3[1] * float((fVec3[1] >= fSlow12))));
			iRec4[0] = (iSlow13 * (iRec4[1] + 1));
			fRec5[0] = (fSlow14 + (fConst9 * fRec5[1]));
			float fTemp2 = std::tan((fConst7 * fRec5[0]));
			float fTemp3 = (1.0f / fTemp2);
			float fTemp4 = (((fTemp3 + 1.0f) / fTemp2) + 1.0f);
			fRec0[0] = ((fSlow1 * (fRec1[0] * std::max<float>(0.0f, (std::min<float>(fRec3[0], std::max<float>(((fConst5 * (1.0f - fRec3[0])) + 1.0f), 0.800000012f)) * (1.0f - (fConst6 * float(iRec4[0]))))))) - (((fRec0[2] * (1.0f - ((1.0f - fTemp3) / fTemp2))) + (2.0f * (fRec0[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp2)))))) / fTemp4));
			output0[i0] = FAUSTFLOAT(((((0.699999988f * fRec0[0]) + (1.39999998f * fRec0[1])) + (0.699999988f * fRec0[2])) / fTemp4));
			iVec0[1] = iVec0[0];
			fRec2[1] = fRec2[0];
			fVec1[1] = fVec1[0];
			IOTA = (IOTA + 1);
	...
	FAUST_ADDHORIZONTALSLIDER("cc1", fHslider0, 127.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDNUMENTRY("freq", fEntry0, 400.0f, 0.0f, 20000.0f, 0.10000000000000001f);
	FAUST_ADDNUMENTRY("gain", fEntry1, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDBUTTON("gate", fButton0);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, cc1, "cc1", fHslider0, 127.0f, 0.0f, 127.0f, 1.0f) \
		p(NUMENTRY, freq, "freq", fEntry0, 400.0f, 0.0f, 20000.0f, 0.10000000000000001f) \
